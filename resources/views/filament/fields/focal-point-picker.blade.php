...
<div
    x-load-css="[@js(\Filament\Support\Facades\FilamentAsset::getStyleHref('filament-focal-point-picker', package: 'frankencms/franken-cms/filament-focal-point-picker'))]"
    x-data="{
