<x-dynamic-component
    ...
    :field="$field"
    class="filament-seo-slug-input-wrapper -mt-3"
>
    <div
        x-data="{
    ...
    >
        <div
            {{ $attributes->merge($getExtraAttributes())->class(['filament-forms-text-input-component group flex items-center justify-between gap-4 text-sm']) }}
        >
            @if ($getReadOnly())
                <span class="flex">
            ...
            @else
                <span class="@if (!$getState()) flex items-center gap-1 @endif">
                    ...
                    >
                        ...
                        <span class="sr-only">
                            {{ __('franken-cms::messages.permalink_action_edit') }}
                        </span>
                    </a>
                ...
                <div class="mx-2 flex-1" x-show="editing" style="display: none">
                    <div
                        class="fi-input-wrapper focus-within:ring-primary-600 dark:focus-within:ring-primary-500 fi-fo-text-input flex overflow-hidden rounded-lg bg-white shadow-sm ring-1 ring-gray-950/10 transition duration-75 focus-within:ring-2 dark:bg-white/5 dark:ring-white/20"
                    >
                        <input
                            type="text"
                            x-ref="slugInput"
                ...
                <div x-show="editing" class="flex gap-2 space-x-2" style="display: none">
                    ...
                    >
                        <span class="sr-only">
                            {{ __('franken-cms::messages.permalink_action_reset') }}
                        </span>
                    </x-filament::link>
                    ...
                    >
                        <span class="sr-only">
                            {{ __('franken-cms::messages.permalink_action_cancel') }}
                        </span>
                    </x-filament::link>
                </div>
