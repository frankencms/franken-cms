...
class GenerateImageTitleAction extends BaseAiAction
{
    protected function getActionKey(): string
    {
        return 'generate_image_title';
    }
    ...
    protected function setUp(): void
    {
        ...
        // Image title should be short and descriptive (3-8 words)
        $this->targetLength(10, 60);
    }
}
