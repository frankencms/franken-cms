...
{
    //    protected string $view = 'forms.components.slug-input';
    protected string $view = 'franken-cms::forms.components.slug-input';
    ...
    public function getVisitLinkLabel(): string
    {
        ...
        return $label ?: __('Visit') . ' ' . $this->getSlugInputModelName();
    }

    public function slugInputLabelPrefix(?string $labelPrefix): static
    {
        $this->labelPrefix = $labelPrefix ?? __('Permalink');
