...
class UserBioForm
{
    public static function make(Schema $schema): Schema
    {
        return $schema
            ...
            ->components([
                Section::make('User')
                    ->description('Select the user this bio belongs to.')
                    ->schema([
                        Select::make('user_id')
                            ->label('User')
                            ...
                            ->validationMessages([
                                'unique' => 'This user already has a bio.',
                            ])
                            ->columnSpanFull(),
                    ]),
                ...
                Section::make('Author Biography')
                    ...
                    ->schema([
                        SpatieMediaLibraryFileUpload::make('bio_image')
                            ...
                            ->image()
                            ->imageEditor()
                            ->when(config('franken-cms.user_bio.image_shape', 'circle') === 'circle', fn ($component) => $component->avatar())
