...
<x-theme::layouts.main>
    <x-slot:main>
        ...
        <section class="relative overflow-hidden bg-gradient-to-br from-black via-slate-950 to-slate-900 py-20 text-white">
            ...
            <div class="relative z-10 container mx-auto px-4">
                <div class="mx-auto max-w-5xl text-center">
                    ...
                    <h1 class="mb-8 bg-gradient-to-r from-lime-400 via-emerald-300 to-cyan-400 bg-clip-text text-5xl leading-tight font-extrabold tracking-tight text-transparent drop-shadow-[0_0_30px_rgba(163,230,53,0.5)] md:text-6xl lg:text-7xl xl:text-8xl">
                        @frankenText(
                            'hero.title',
                            [
                                'label'     => 'Hero Title',
                    ...
                    <p class="mx-auto mb-12 max-w-3xl text-xl leading-relaxed text-emerald-100/90 md:text-2xl lg:text-3xl">
                        @frankenTextarea(
                            'hero.subtitle',
                            [
                                'label'     => 'Hero Subtitle',
            ...
            <div class="absolute right-0 bottom-0 left-0 h-px bg-gradient-to-r from-transparent via-lime-500/70 to-transparent shadow-[0_0_10px_rgba(163,230,53,0.7)]"></div>
        </section>
        ...
        <section id="features" class="relative bg-gradient-to-b from-slate-950 to-slate-900 py-20 md:py-28 lg:py-32">
            <div class="container mx-auto px-4">
                ...
                <div class="mb-16 text-center md:mb-20">
                    <h2 class="mb-6 bg-gradient-to-r from-lime-400 via-emerald-400 to-lime-400 bg-clip-text text-4xl font-extrabold tracking-tight text-transparent drop-shadow-[0_0_20px_rgba(163,230,53,0.3)] md:text-5xl lg:text-6xl">
                        @frankenText(
                            'features.title',
                            [
                    ...
                    <p class="mx-auto mb-12 max-w-3xl text-lg leading-relaxed text-emerald-200/80 md:text-xl lg:text-2xl">
                        @frankenTextarea(
                            'features.subtitle',
                            [
                ...
                <div class="grid gap-6 md:grid-cols-2 md:gap-8 lg:grid-cols-3 lg:gap-10">
                    ...
                    @frankenRepeater(
                        ...
                        <div class="group relative rounded-2xl border border-emerald-500/20 bg-gradient-to-br from-slate-900 to-slate-800 p-8 shadow-lg shadow-emerald-500/10 transition-all duration-300 hover:-translate-y-2 hover:border-lime-400/50 hover:shadow-2xl hover:shadow-lime-500/30">
                            {{-- Electric energy gradient that appears on hover --}}
                            <div class="absolute inset-0 rounded-2xl bg-gradient-to-br from-lime-500/5 to-cyan-500/5 opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>

                            <div class="relative z-10">
                                {{-- Icon with toxic chemical glow --}}
                                <div class="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-xl bg-gradient-to-br from-lime-500/20 to-emerald-500/20 text-4xl shadow-md ring-1 shadow-lime-500/20 ring-lime-400/30 transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-lime-400/40 group-hover:ring-lime-400/60">
                                    {{ $franken->icon ?? '🚀' }}
                                </div>
                                ...
                                <p class="text-base leading-relaxed text-emerald-200/70">{{ $franken->description }}</p>
                            </div>

                            {{-- Electric border pulse on hover --}}
                            <div class="absolute inset-x-0 bottom-0 h-1 rounded-b-2xl bg-gradient-to-r from-lime-400 via-cyan-400 to-lime-400 opacity-0 shadow-[0_0_15px_rgba(163,230,53,0.6)] transition-opacity duration-300 group-hover:opacity-100"></div>
                        </div>
                    @endFrankenRepeater
                </div>
            </div>
        ...
        --}}
        <section class="relative overflow-hidden bg-gradient-to-br from-emerald-900 via-teal-900 to-cyan-900 py-20 text-white md:py-24 lg:py-28">
            ...
            <div class="pointer-events-none absolute inset-0 opacity-20">
                ...
                <div class="absolute right-0 bottom-0 h-full w-1/2 bg-gradient-to-tl from-cyan-500/30 to-transparent"></div>
            </div>
            ...
            <div class="relative z-10 container mx-auto px-4">
                <div class="mx-auto max-w-4xl text-center">
                    ...
                    <h2 class="mb-6 bg-gradient-to-r from-lime-300 via-emerald-200 to-cyan-300 bg-clip-text text-4xl leading-tight font-extrabold tracking-tight text-transparent drop-shadow-[0_0_25px_rgba(163,230,53,0.4)] md:text-5xl lg:text-6xl">
                        @frankenText(
                            'cta.title',
                            [
                                'label'     => 'CTA Title',
                    ...
                    <p class="mx-auto mb-10 max-w-2xl text-lg leading-relaxed text-emerald-100/90 md:text-xl lg:text-2xl">
                        @frankenTextarea(
                            'cta.description',
                            [
                    ...
                    >
                        ...
                        {{-- Electric bolt shine effect --}}
                        <div class="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-white/50 to-transparent transition-transform duration-700 group-hover:translate-x-full"></div>
                    </a>
                </div>
            </div>
        </section>
